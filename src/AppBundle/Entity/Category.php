 ...
 */
class Category implements BaseFieldsI
{
    private $em;
    ...
    public function getDisplayName($locale)
    {
        ...
        return $entityManager->getRepository('AppBundle:CategoryTransliteration')
            ->findTransliterationByLanguageCode($this, $locale);
    }
}
